...
const metrics: Metric[] = [
  {
    ...
    value: "1.284",
    note: "↑ 18% vs. periodo anterior",
    tone: "positive",
  },
  {
    label: "Alcance",
    value: "892",
    note: "↑ 11% vs. periodo anterior",
    tone: "positive",
  },
  {
    label: "Interacciones",
    value: "74",
    note: "Sin cambio significativo",
    tone: "neutral",
  },
  {
    label: "Seguidores",
    value: "3",
    note: "Total actual de la cuenta",
    tone: "neutral",
  },
];
    ...
    <>
      ...
      <div className="mx-auto max-w-[1180px] px-5 py-9 md:px-10 md:py-12">
        ...
        <h1 className="max-w-3xl text-[clamp(2.25rem,4.1vw,3.25rem)] font-bold leading-[1.02] tracking-[-0.045em]">
          Hay una señal clara en tus primeros segundos.
        </h1>
        <p className="mt-4 max-w-2xl text-[15px] leading-6 text-graphite">
          Tu último Reel consiguió distribución, pero perdió atención antes de presentar la promesa.
          Esta es la oportunidad más importante para tu próxima pieza.
        </p>
        ...
        <section className="relative mt-10 grid overflow-hidden rounded-card border border-mist before:absolute before:left-7 before:top-0 before:h-3 before:w-px before:-translate-y-full before:bg-ink lg:grid-cols-[1.45fr_.7fr]">
          <div className="p-7">
            <p className="flex items-center gap-2 text-xs font-semibold text-graphite">
              ...
              Señal prioritaria · Reel del 2 de septiembre
            </p>
            <h2 className="mt-4 max-w-2xl text-2xl font-semibold leading-tight tracking-[-0.025em]">
              El 41,9% omitió el video durante los primeros tres segundos.
            </h2>
            <p className="mt-3 text-[13px] leading-5 text-graphite">
              El alcance fue estable frente a tu referencia, pero el hook tardó en revelar el
              conflicto. Conservá el encuadre y adelantá la promesa al primer segundo.
            </p>
          </div>
          <aside className="border-t border-mist p-7 lg:border-l lg:border-t-0">
            ...
            <p className="my-3 text-base font-semibold leading-snug">
              Crear tres variantes de hook para volver a probar la idea.
            </p>
        ...
        <section className="mt-12">
          <div>
            ...
            <p className="mt-1 text-[11px] text-muted">
              Datos oficiales de Instagram · últimos 7 días
            </p>
          </div>
              ...
              >
                ...
                <p
                  className={`mt-1.5 text-[10px] ${
                    metric.tone === "positive" ? "text-success" : "text-muted"
                  }`}
                >
                  {metric.note}
                </p>
