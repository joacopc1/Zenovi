...
- [-] Validar cada cifra de Analíticas contra el panel profesional de Instagram: `npm run report:analytics [-- usuario]` imprime los totales de 7 y 30 días con las mismas funciones de la página. Primera corrida con @elcostarrica: interacciones (6) supera la suma de me gusta, comentarios, guardados y compartidos (5), porque el total de Meta incluye tipos que no se desglosan. Falta repetirlo con una cuenta de actividad real.
