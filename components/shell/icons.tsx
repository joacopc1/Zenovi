...
export const CollapseSidebarIcon = (props: IconProps) => <Icon {...props}><rect x="3" y="4" width="18" height="16" rx="2.5"/><path d="M8 4v16m7-12-4 4 4 4"/></Icon>;
export const BoltIcon = (props: IconProps) => <Icon {...props}><path d="m13 2-7 11h6l-1 9 7-12h-6Z"/></Icon>;
